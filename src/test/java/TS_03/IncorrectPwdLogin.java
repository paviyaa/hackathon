...
public class IncorrectPwdLogin extends Utility.BeginnerClass {
	...
	public void startBrowser() throws IOException {
		...
		if (ExtentReport.log == null)
			ExtentReport.log = ExtentReport.reports.createTest("Incorrect Password");
	...
	public void setValuesForSignin() {
		...
		// Logging the execution process in HTML
		report.select(logger, "Giving incorrect value to Password");

		// Passing value for Email Box
		loginPage.setPwd("invalidPassword");
	...
	public void outputDisplay() {
		...
		// Logging the execution process in HTML
		report.display(logger, "Error message saying 'Wrong password'is asserted and displayed");
