...
public class InvalidPwdLogin extends Utility.BeginnerClass {
	...
	public void startBrowser() throws IOException {
		...
		if (ExtentReport.log == null)
			ExtentReport.log = ExtentReport.reports.createTest("Invalid Password");
	...
	public void setValuesForSignin() {
		...
		// Logging the execution process in HTML
		report.select(logger, "Giving no value to Password");

		// Passing value for Email Box
		loginPage.setPwd("blankPassword");
	...
	public void outputDisplay() {
		...
		// Logging the execution process in HTML
		report.display(logger, "Error message saying 'Enter a password' is asserted and displayed");
