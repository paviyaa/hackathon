...
public class InvalidEmailLogin extends Utility.BeginnerClass {
	...
	public void startBrowser() throws IOException {
		...
		if (ExtentReport.log == null)
			ExtentReport.log = ExtentReport.reports.createTest("InvalidEmail");
	...
	public void setValuesForSignin() {
		...
		// Logging the execution process in HTML
		report.select(logger, "Giving no value to Email");

		// Passing value for Email Box
		loginPage.setEmail("invalidMailID");
	...
	public void outputDisplay() {
		...
		// Logging the execution process in HTML
		report.display(logger, " Error message saying 'Enter an email' is asserted and displayed");
